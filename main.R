...
##                                          ##
## AUTHOR: YI ZHANG                         ##
## EMAIL: UC.YIZHANG@GMAIL.COM              ##
##   (YI.ZHANG@HUNTINGTON.COM)              ##
## ######################################## ##
# packages_list <- c("reshape2", "plyr", "timeDate", "RCurl", "XML", "RJSONIO", "zipcode", "maps", "randomForest", "mboost", "e1071", "MASS")
# install.packages(pkg = packages_list)
# rm(list="packages_list")
# ---- Data Wrangler --#
...
library(e1071)         # svm
library(MASS)          # linear regression stepwise selection
